...
export const ADD_USER = gql`
  mutation addUser($username: String!, $email: String!, $password: String!, $lastName: String) {
    addUser(username: $username, email: $email, password: $password, lastName: $lastName) {
      token
      user {
        _id
        username
